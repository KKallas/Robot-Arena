...
🤖 *Generated by Issue Manager Agent (Claude {CLAUDE_MODEL})*"""
    ...
    return f"""You are the Issue Manager agent for MechArena.
{test_notice}
## Your Instructions
...
def main():
    parser = argparse.ArgumentParser(
        description="Moderate GitHub issues for MechArena",
...
Examples:
  ...
  python moderate_issues.py --issue 123         # Actually process issue #123
    ...
    print("=" * 60)
    print("  MechArena Issue Moderator")
